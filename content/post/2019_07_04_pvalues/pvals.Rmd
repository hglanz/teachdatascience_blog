...
We appreciate the editorial in *The American Statisitican*, "[Moving to a World Beyond `p < 0.05`](https://doi.org/10.1080/00031305.2019.1583913)" by Wasserstein, Schirm, and Lazar.    Instead of focusing only on the "don'ts", they provide guidance on how statistical inference can be used effectively through the acronym **ATOM**.
...
> 'statistically signficant' -- don't say it and don't use it.
