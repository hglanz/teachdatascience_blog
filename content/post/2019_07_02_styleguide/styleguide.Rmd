...
At UseR! 2018, Jenny Bryan gave a talk on [Code smells and feels](https://www.youtube.com/watch?v=7oyiPBjLAWY&feature=youtu.be) detailing why good coding practice is important.  We recommend everyone listen to her advice.  Indeed, it is also worth checking out our Teach Data Science blog about [her talk and refactoring](https://teachdatascience.com/refactoring/), available on Monday, July 8, 2019.
...
There are multiple `R` style guides out there (some of which are linked at the bottom of this post), but most of them begin with [Google's R Style Guide](https://google.github.io/styleguide/Rguide.xml).
...
* Hadley Wickham's Advanced R Style Guide: [http://adv-r.had.co.nz/Style.html#undefined](http://adv-r.had.co.nz/Style.html#undefined)
